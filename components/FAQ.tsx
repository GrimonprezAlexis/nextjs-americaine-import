  ...
  const faqItems = [
    {
      ...
      answer:
        "L'importation d'un véhicule américain en France implique plusieurs étapes : l'achat du véhicule, son transport, le dédouanement, l'homologation et l'immatriculation. Chez Americaine Motor, nous nous occupons de toutes ces démarches pour vous, de A à Z.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Absolument ! Notre atelier est équipé des dernières technologies de diagnostic et nos mécaniciens sont formés sur les modèles américains récents. Nous pouvons assurer l'entretien et la réparation de la plupart des marques américaines, qu'il s'agisse de véhicules classiques ou modernes.",
    },
  ];
    ...
    <section className="py-20 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="max-w-3xl mx-auto bg-gray-900/50 rounded-lg p-6"
        >
          <Accordion type="single" collapsible className="w-full space-y-4">
            {faqItems.map((item, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="bg-gray-800/50 rounded-lg px-6 py-4 border-none"
              >
                <AccordionTrigger className="text-lg font-semibold text-white hover:text-blue-400 transition-colors [&[data-state=open]>div]:text-blue-400">
                  {item.question}
                </AccordionTrigger>
